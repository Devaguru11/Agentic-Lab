...
**Ready to submit to your mentor!**

---

## 📝 Citation

If you use this code in your research, here's the recommended citation:

```
@misc{ai_benchmarking_2025,
  title={A Standardized Benchmarking Protocol for Comparing Agentic AI Systems 
         with Rule-Based and Single-Model AI Baselines Using Clinically Relevant Metrics},
  author={Miriyala, Jeevan Reddy and Nanduri, Devaguru and Khan, Farhan and Reddy, Samhita},
  year={2025},
  note={Research supervised by Dr. Resham Raj}
}
```
